...
export default class Test extends React.Component {
  ...
  handleSubmitPlayground = event => {
    ...
    data.append(
      "file",
      this.state.selectedFilePlayground,
      this.state.selectedFilePlayground.name
    );
      ...
      <React.Fragment>
        ...
        <div>
          <form encType="multipart/form-data" action="">
            ...
            <table>
              <tr>
                <td>File to upload for playground:</td>
                <td>
                  <input
                    type="file"
                    name="file"
                    onChange={this.handleSelectedFilePlayground}
                  />
                </td>
              </tr>
              <tr>
        ...
        <div>
          <img crossOrigin="true" alt="" src={PlaygroundAPI.getUserImage()} />
          <img
            crossOrigin="true"
            alt=""
            src={PlaygroundAPI.getPlaygroundImage(2)}
          />
        </div>
      </React.Fragment>
    );
