...
class ModalPlayground extends React.Component {
  ...
  async handleAdding() {
    ...
    let playground = {
      ...
      address:
        this.props.properties.street +
        " " +
        this.props.properties.cp +
        " " +
        this.props.properties.city
    };
    ...
    await PlaygroundAPI.uploadImagePlayground(
      idPlayground,
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Veillez à compléter chaque étape du formulaire avant de passer à
              la suivante.
            </DialogContentText>
          </DialogContent>
          <Stepper />
          <DialogActions>
            ...
            <Button
              ...
              color="primary"
              disabled={
                this.props.properties.step !== 5 || !this.props.properties.name
              }
            >
              Ajouter le terrain
            </Button>
