          ...
          >
            <Popup onOpen={() => this.setCurrentPlayground(playground.id)}>
              {this.state.showPopup && (
                <PlaygroundDetails playground={this.state.currentPlayground} />
              )}
            </Popup>
          </Marker>
        ))}
    ...
    return (
      <MuiThemeProvider theme={theme}>
        <div>
          ...
          >
            <TileLayer url="https://api.mapbox.com/styles/v1/playground-app/cjqgjco2v0en02squr5fkrcb9/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicGxheWdyb3VuZC1hcHAiLCJhIjoiY2pxZ2piYXdhMDBkOTQzcG5zcG9idWNrMCJ9.H64SLGKZlHfQeDTBGidTqQ" />
