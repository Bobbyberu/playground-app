...
class ReportPlaygroundModal extends React.Component {
  ...
  handleSubmit() {
    ...
    PlaygroundAPI.reportPlayground(
      user,
  ...
  renderCompleted() {
    return (
      <React.Fragment>
        <DialogContent>
          Votre signalement sur {this.props.playground.name} a bien été envoyé !
        </DialogContent>
        <DialogActions>
          <Button onClick={this.handleClose} color="primary">
            OK
...
export default connect(mapStateToProps)(
  withStyles(styles)(ReportPlaygroundModal)
);
