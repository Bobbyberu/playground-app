...
class ReportCommentModal extends React.Component {
    ...
    render() {
        const { classes, open, comment } = this.props;
    ...
    renderForm(classes) {
        return (
            <React.Fragment>
                <DialogTitle><span role="img">🏴</span> Signaler un avis</DialogTitle>
    ...
    renderCompleted() {
        ...
        return (
            <React.Fragment>
                <DialogContent>Votre signalement sur le commentaire de {author.username} a bien été envoyé !</DialogContent>
                <DialogActions>
