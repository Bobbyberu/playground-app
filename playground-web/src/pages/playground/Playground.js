...
class Playground extends Component {
  ...
  async toggleFavorite() {
    ...
    PlaygroundAPI.updateFavorite(user.id, this.state.playground.id).catch(
      err => {
        console.log(err);
        this.setState({
          favorited: !this.state.favorited
          ...
          <div className={classes.global}>
            <Card className={classes.card}>
              ...
              <CardMedia
                ...
                image={PlaygroundAPI.getPlaygroundImage(
                  this.state.playground.id
                )}
              ...
              <CardContent className={classes.cardContent}>
                <div>
                  <div
                    className={classes.titleRow + " row col-12 justify-content"}
                  >
                    ...
                    {AuthService.isUser() && (
                      <React.Fragment>
                        ...
                        <CardActions
                          ...
                          title="Ajouter ce playground à vos favoris"
                        >
                          <IconButton
                            color="primary"
                            className={classes.favorite}
                        ...
                        <CardActions
                          ...
                          title="Signaler un playground"
                        >
                          <IconButton
                            color="primary"
                            onClick={this.toggleReportPlayground}
                          >
                  ...
                  <Typography
                    className={classes.playgroundAddress}
                    component="h3"
                  >
                ...
                <div>
                  <div
                    className={
                      classes.ratingRow + " row col-12 justify-content-between"
                    }
                  >
                    ...
                    <StarRating
                      rating={this.state.playground.averageMark}
                      number={true}
                    />
                  </div>
                  <Divider
